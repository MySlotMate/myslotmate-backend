...
func (r *postgresBookingRepository) Create(ctx context.Context, booking *models.Booking) error {
	...
	_, err := r.db.ExecContext(ctx, query,
		booking.ID, booking.EventID, booking.UserID, booking.OccurrenceDate, booking.Quantity, booking.Status, booking.PaymentID, booking.IdempotencyKey, booking.AmountCents, booking.ServiceFeeCents, booking.NetEarningCents, booking.NotificationSentWhatsapp, booking.NotificationSentEmail, booking.ReminderNotificationSentEmail, booking.ReminderNotificationSentWhatsapp, booking.CreatedAt, booking.UpdatedAt, booking.PriceTierID, booking.UnitPriceCents, booking.CouponID,
	)
	return err
}
